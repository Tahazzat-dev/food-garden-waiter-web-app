    ...
    return (
        <section className='w-full' >
            <Container className='lg:mt-4'>
                <div className="w-full flex items-center justify-center min-h-[65px] md:min-h-[120px] lg:min-h-[200px] bg-slate-400 dark:bg-slate-600 rounded-md lg:rounded-xl relative">
