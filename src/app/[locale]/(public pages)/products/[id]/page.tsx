                ...
                !product ? <NoFoodFound /> :
                    <div className="w-full">
                        <Container className="pt-10">
                            <div className="w-full flex border border-slate-400 dark:border-slate-600 rounded-[6px]">
                                {/* == images ====  */}
                                <div className=" w-full lg:w-5/12 flex lg:flex-col gap-2.5 md:gap-3.5 border-r border-slate-400 dark:border-slate-600 lg:gap-4 p-2.5 md:p-3.5 lg:p-4">
                                    <div className="w-5/6 lg:w-full max-h-[400px] overflow-hidden rounded-[6px]">
