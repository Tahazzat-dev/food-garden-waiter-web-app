...
export default function MobileSearch({ className = '' }: { className?: string }) {
    return (
        <>
            <Container className={cn("bg-inherit sticky z-[9999] top-[81px] lg:top-[83.53px] py-2 md:my-2 lg:my-4 xl:my-6 left-0", className)}>
                <div className='relative mx-auto flex fg_rounded items-center  h-9 gap-2'>
