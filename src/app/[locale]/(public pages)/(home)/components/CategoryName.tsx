...
export default function CategoryName({ category }: { category: TCategory }) {
    ...
    return (
        <span className={clsx("fg_fs-xs duration-300 text-center font-semibold absolute bg-slate-800/20 py-1 backdrop-blur-xs block w-full text-white z-30 left-0 bottom-0",
